...
-- Tabel Exercise Logs (Hasil Latihan Pasien)
CREATE TABLE IF NOT EXISTS exercise_logs (
    ...
    pain_before INT DEFAULT 0,
    pain_after INT DEFAULT 0,
...
('ex-001', 'Chin Tuck', 'Gentle neck exercise to improve posture', 'Neck', 'Beginner', 'Mobility', 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=400', 'https://www.youtube.com/watch?v=u8C5LgpK3r4', '1. Sit upright. 2. Gently tuck chin toward chest. 3. Hold 5s.'),
('ex-002', 'Scapular Retraction', 'Strengthen shoulder blade muscles', 'Shoulder', 'Beginner', 'Strengthening', 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400', 'https://www.youtube.com/watch?v=QqWe8t8sF5c', '1. Pull shoulder blades back and down. 2. Squeeze for 5s.'),
('ex-003', 'Hamstring Stretch', 'Improve lower limb flexibility', 'Lower Back', 'Beginner', 'Stretching', 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=400', 'https://www.youtube.com/watch?v=vTjWQeM6z7A', '1. Sit with legs extended. 2. Lean forward at hips.'),
...
('ex-005', 'Heel Slide', 'Improve knee range of motion', 'Knee', 'Beginner', 'Mobility', 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400', 'https://www.youtube.com/watch?v=7CkM4A6jK1g', '1. Slide heel toward buttock. 2. Hold, then return.'),
('ex-006', 'Calf Stretch', 'Stretch ankle and calf muscles', 'Ankle', 'Beginner', 'Stretching', 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=400', 'https://www.youtube.com/watch?v=YMmgqO8Jo-k', '1. Lean against wall. 2. Step one foot back, keep heel down.');
...
('tmpl-001', 'Neck Pain Relief', 'Gentle mobility and isometric strengthening for cervical spine.', 'Improve neck mobility', 'Neck', '4 weeks', 'Active', NULL, '[{"id": "ex-001", "name": "Chin Tucks", "sets": 3, "reps": 10, "holdTime": 5, "video_url": "https://www.youtube.com/watch?v=u8C5LgpK3r4", "notes": "Gently tuck your chin towards your neck, maintaining upright posture."}]'),
('tmpl-002', 'Low Back Stabilization', 'Core engagement and lumbar stabilization protocol.', 'Core stability', 'Lower Back', '6 weeks', 'Active', NULL, '[{"id": "ex-004", "name": "Bridging", "sets": 3, "reps": 10, "holdTime": 5, "video_url": "https://www.youtube.com/watch?v=wPM8icPu6H8", "notes": "Lift your hips off the floor while keeping your back straight."}]'),
('tmpl-003', 'Frozen Shoulder (Phase 1)', 'Passive and active-assisted ROM for adhesive capsulitis.', 'Increase ROM', 'Shoulder', '4 weeks', 'Active', NULL, '[{"id": "ex-002", "name": "Scapular Retraction", "sets": 3, "reps": 10, "holdTime": 5, "video_url": "https://www.youtube.com/watch?v=QqWe8t8sF5c", "notes": "Squeeze your shoulder blades."}]'),
('tmpl-004', 'ACL Post-Op (Weeks 1-4)', 'Early phase ACL reconstruction protocol.', 'Post-op recovery', 'Knee', '4 weeks', 'Active', NULL, '[{"id": "ex-005", "name": "Heel Slides", "sets": 3, "reps": 15, "holdTime": 0, "video_url": "https://www.youtube.com/watch?v=7CkM4A6jK1g", "notes": "Slowly slide your heel towards your buttock."}]'),
('tmpl-005', 'Stroke Rehab (Upper Limb)', 'Neuro-rehabilitation focusing on upper extremity function.', 'Functional recovery', 'Neurological', '8 weeks', 'Active', NULL, '[{"id": "ex-001", "name": "Chin Tucks", "sets": 3, "reps": 10, "holdTime": 5, "video_url": "https://www.youtube.com/watch?v=u8C5LgpK3r4", "notes": "Gently tuck your chin."}]'),
('tmpl-006', 'Knee Osteoarthritis', 'Quad strengthening and joint offloading strategies.', 'Pain management', 'Knee', '6 weeks', 'Active', NULL, '[{"id": "ex-005", "name": "Heel Slides", "sets": 3, "reps": 15, "holdTime": 0, "video_url": "https://www.youtube.com/watch?v=7CkM4A6jK1g", "notes": "Heel slides for knee mobility."}]');